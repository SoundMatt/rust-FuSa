...
| SBOM | `sbom.json` | yes | :white_check_mark: present |
| FMEA | `fmea.json` | no | :white_check_mark: present |
| TARA / threat analysis | `tara.json` | no | :white_check_mark: present |
| Vulnerability scan | `vuln.json` | no | :x: missing |
